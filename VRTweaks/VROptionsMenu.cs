...
namespace VRTweaks
{
	public static class VRCustomOptionsMenu
	{
		...
		public static void AddVrOptionsTab()
		{
			...
			/*optionsPanel.AddSliderOption(tabIndex, "Subtitle Height", subtitleHeight, 10, 100, 50, 1, delegate (float v)
			{
				subtitleHeight = v;
			...
			}, SliderLabelMode.Float, "0.0", null);
			...
			optionsPanel.AddSliderOption(tabIndex, "Ground Speed Scale", VROptions.groundMoveScale, 0.6f, (float v) =>
			{
				if (v <= 0f)
				{
			...
			optionsPanel.AddToggleOption(tabIndex, "Enable Snap Turning", SnapTurningOptions.EnableSnapTurning, (bool v) => SnapTurningOptions.EnableSnapTurning = v);
			optionsPanel.AddChoiceOption(tabIndex, "Snap Angle", SnapTurningOptions.SnapAngleChoices, SnapTurningOptions.SnapAngleChoiceIndex, (int index) => SnapTurningOptions.SnapAngleChoiceIndex = index);
			...
			optionsPanel.AddToggleOption(tabIndex, "Disable Mouse Look", SnapTurningOptions.DisableMouseLook, (bool v) => SnapTurningOptions.DisableMouseLook = v);
		}
	}
}
